...
if (uri && (uri.startsWith('mongodb://') || uri.startsWith('mongodb+srv://'))) {
  mongoose.connect(uri, { useNewUrlParser: true, useUnifiedTopology: true })
    ...
    .catch((err) => {
      ...
      console.log("Server will continue without MongoDB. Auth features will be disabled.");
    });
} else {
  console.log("MongoDB URI not configured. Server running without database. Auth features disabled.");
}
